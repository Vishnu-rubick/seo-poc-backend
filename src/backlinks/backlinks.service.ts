...
export class BacklinksService {
    ...
    async fetchBacklinks(projectId: string){
    ...
    async getBacklinks(projectId: string, offset: number, limit: number){
        await this.fetchBacklinks(projectId);
        const config = await this.commonService.getConfig();
        const domain = config.domain;
    ...
    async getBacklinksDashboard(projectId: string){
        await this.fetchBacklinks(projectId);
        const config = await this.commonService.getConfig();
        const domain = config.domain;
