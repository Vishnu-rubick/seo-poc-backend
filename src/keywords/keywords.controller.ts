...
//         return await this.keywordsService.getKeywordsDashboard(userId, projectId);
//     }
...
//     ) {
//         if(!projectId)  throw new NotFoundException('project Id cannot be NULL');
//         return await this.keywordsService.getKeywords(query.userId, projectId, query.type, query.offset, query.limit);
//     }
// }