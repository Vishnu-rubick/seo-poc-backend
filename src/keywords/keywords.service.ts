...
//     async fetchKeywords(userId: string, projectId: string){
...
//     async getKeywordsDashboard(userId: string, projectId: string) {
//         await this.fetchKeywords(userId, projectId);
//         const commonData = await this.commonService.fetchFileData(`./data/${projectId}_common_data.json`);
//         const allKeywords = await this.getAllKeywords(commonData, userId);
//         const sharedKeywords = await this.getSharedKeywords(commonData, userId);
//         const missingKeywords = await this.getMissingKeywords(commonData, userId);
//         const weakKeywords = await this.getWeakKeywords(commonData, userId);
//         const untappedKeywords = await this.getUntappedKeywords(commonData, userId);
//         const strongKeywords = await this.getStrongKeywords(commonData, userId);
//         let chartObj = {};
...
//     async getKeywords(userId: string, projectId: string, type: string = "all", offset: number = 0, limit: number = 10){
//         await this.fetchKeywords(userId, projectId);
//         const commonData = await this.commonService.fetchFileData(`./data/${projectId}_common_data.json`);

//         let data = [];
//         if(type == "all"){
//             data = await this.getAllKeywords(commonData, userId);
//         }
//         else if(type == "shared"){
//             data = await this.getSharedKeywords(commonData, userId);
//         }
//         else if(type == "missing"){
//             data = await this.getMissingKeywords(commonData, userId);
//         }
//         else if(type == "weak"){
//             data = await this.getWeakKeywords(commonData, userId);
//         }
//         else if(type == "untapped"){
//             data = await this.getUntappedKeywords(commonData, userId);
//         }
//         else if(type == "strong"){
//             data = await this.getStrongKeywords(commonData, userId);
//         }
...
//     async getAllKeywords(data: any, userId: string){
//         let res = [];
...
//     async getSharedKeywords(data: any, userId: string){
//         let res = [];
//         const config = await this.commonService.getProject(userId);
...
//     async getMissingKeywords(data: any, userId: string){
//         let res = [];
//         const config = await this.commonService.getProject(userId);
//         const competitors = await config.competitors
//         const domain = await config.domain
...
//     async getWeakKeywords(data: any, userId: string){
//         let res = [];
//         const config = await this.commonService.getProject(userId);
//         const competitors = await config.competitors
//         const domain = await config.domain
...
//     async getUntappedKeywords(data: any, userId: string){
//         let res = [];
//         const config = await this.commonService.getProject(userId);
//         const competitors = await config.competitors
//         const domain = await config.domain
...
//     async getStrongKeywords(data: any, userId: string){
//         let res = [];
//         const config = await this.commonService.getProject(userId);
//         const competitors = await config.competitors
//         const domain = await config.domain
